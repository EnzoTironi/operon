# OPR-AUTHINT-05 - Qualify OAuth and MCP profiles
...
**Depends on:** OPR-AUTHINT-01, OPR-AUTHINT-02
...
Migrate or isolate old MCP SDK profile; compose one OAuth provider, audience verification, shared DPoP replay and safe CIMD transport.
