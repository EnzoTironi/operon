# OPR-VER-006 - Induction and counterexample minimality
...
Unbounded claims require an inductive argument; shortest-counterexample claims require minimality evidence.
...
- **VER-006.T01:** Check base and inductive steps on both provable and inconclusive models. **Expected:** No unbounded-safe label from bounded absence of counterexamples alone.
- **VER-006.T02:** Return a length-k witness and check shorter horizons under the same assumptions. **Expected:** Minimality is substantiated or the result is simply labeled a witness.
...
Requirement IDs: VER-006. Acceptance case IDs: VER-006.T01, VER-006.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
