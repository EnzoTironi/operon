...
- [ ] promotion rejects evidence from another candidate/profile.
- [ ] failed rollout stops before next cohort.
- [ ] rollback preserves history and reports uncompensated effects.
