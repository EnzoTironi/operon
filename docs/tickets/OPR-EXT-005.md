# OPR-EXT-005 - Compensation as forward work
...
Compensations are independently authorized actions with explicit irreversible boundaries and durable progress.
...
- **EXT-005.T01:** Fail a later saga step and execute registered compensations. **Expected:** Reverse order, guards and audit are preserved; original decisions are not erased.
- **EXT-005.T02:** Deny or fail one compensation after another succeeds. **Expected:** Remaining obligations and manual recovery are visible; the saga is not falsely reported fully restored.
...
Requirement IDs: EXT-005. Acceptance case IDs: EXT-005.T01, EXT-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
