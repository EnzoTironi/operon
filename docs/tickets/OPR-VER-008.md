# OPR-VER-008 - Incremental verification equivalence
...
Use a declared dependency graph and verify incremental rechecking against full recomputation.
...
- **VER-008.T01:** Mutate fact/rule/interface/permission dependencies and compare full versus incremental results. **Expected:** Verdicts, conflicts and obligations match; missing dependencies fail.
- **VER-008.T02:** Increase dependency graph size and change locality. **Expected:** Report actual runtime/memory and failure boundaries; no unmeasured logarithmic-scale promise.
...
Requirement IDs: VER-008. Acceptance case IDs: VER-008.T01, VER-008.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
