# OPR-L2-004 - Compliant communication
...
Outputs cannot exceed actor authority, scenario boundaries or allowed commitments.
...
- **L2-004.T01:** Have an observe-tier agent claim it approved/executed or declare a high-risk action safe. **Expected:** The output-quality policy blocks/revises the response; backend execution is independently denied.
- **L2-004.T02:** Evaluate ambiguous unsupported prose not decidable by structured checks. **Expected:** Status remains unverified/review with a stated evaluation boundary, not universal compliance.
...
Requirement IDs: L2-004. Acceptance case IDs: L2-004.T01, L2-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
