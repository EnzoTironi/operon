# OPR-AUTHINT-01 - Freeze and qualify identity dependencies
...
Record core 1.7.4 candidate; resolve actual separately published plugin artifacts and peers, review migrations, qualify current MCP profile and keep production Agent Auth disabled until proven.
