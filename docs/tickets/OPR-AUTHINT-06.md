# OPR-AUTHINT-06 - Implement experimental Agent Auth adapter
...
**Depends on:** OPR-AUTHINT-02, OPR-AUTHINT-05
...
Preserve agent actor; project canonical grants into plugin grants and intersect them at execution; protect custom locations, visibility and upstream credentials.
