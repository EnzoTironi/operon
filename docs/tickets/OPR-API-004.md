# OPR-API-004 - Generated SDK retains ontology types
...
Generate correct required/optional/nullable/enum/union/array/reference/action types with versioned schema metadata.
...
- **API-004.T01:** Compile valid generated clients and intentionally invalid action/property references. **Expected:** Valid programs compile; invalid programs fail without any erasing the contract.
- **API-004.T02:** Execute a packed generated client against the live API including a denied action. **Expected:** Types, runtime serialization, errors and policy all agree.
...
Requirement IDs: API-004. Acceptance case IDs: API-004.T01, API-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
