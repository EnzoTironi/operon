# OPR-RUL-005 - Native/external guard composition
...
Keep local checks in the native layer and invoke complex verification under a fail-closed bounded contract.
...
- **RUL-005.T01:** Make a native rule allow while an external hard rule denies. **Expected:** The composed result cannot grant forbidden execution.
- **RUL-005.T02:** Force verifier timeout, crash, malformed result and out-of-memory/step-limit termination. **Expected:** No permission on failure; record limit, partial result and conservative disposition.
...
Requirement IDs: RUL-005. Acceptance case IDs: RUL-005.T01, RUL-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
