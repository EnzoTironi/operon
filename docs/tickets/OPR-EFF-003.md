# OPR-EFF-003 - Resource finalization
...
Database connections, files, servers and workers have scoped acquisition and cleanup paths.
...
- **EFF-003.T01:** End the live scope by success, typed failure, defect and interruption. **Expected:** Every acquired resource is released once; later scopes can reopen the database/port.
- **EFF-003.T02:** Fail partway through layered resource initialization. **Expected:** Previously acquired resources finalize; no background worker or credential-bearing handle is leaked.
...
Requirement IDs: EFF-003. Acceptance case IDs: EFF-003.T01, EFF-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
