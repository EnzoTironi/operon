# OPR-AUD-001 - Nine-group DecisionRecord
...
Record outcome, input snapshot, rules, logic/models, guard reasons, actor chain, alternatives, times and disagreements.
...
- **AUD-001.T01:** Execute, deny, defer/review, degrade and override representative decisions. **Expected:** Every relevant disposition has an adequate dossier, not only successful execution.
- **AUD-001.T02:** Give a reviewer only retained records and versions. **Expected:** They can reconstruct what was known, which checks ran, who proposed/confirmed and what changed.
...
Requirement IDs: AUD-001. Acceptance case IDs: AUD-001.T01, AUD-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
