# OPR-ORG-001 - Decision Canvas and eight-stage evidence
...
Capture decision owner, alternatives, evidence R(d), rules, actions, source systems and baseline/target measures; track the book’s discovery-to-operation deliverables.
...
- **ORG-001.T01:** Onboard one actual chosen workflow with named business owners and evidence sources. **Expected:** Required decisions and responsibilities are explicit; unresolved business rules remain open decisions.
- **ORG-001.T02:** Review source inventory, minimal model, logic, action, security, pilot and operation deliverables. **Expected:** Stage progression depends on evidence, not counting types or writing a strategy document.
...
Requirement IDs: ORG-001. Acceptance case IDs: ORG-001.T01, ORG-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
