# OPR-FULL-024 - Avaliação de modelos
...
Troca de modelo exige avaliação versionada e política de dados.
...
- **FULL-ACC-024:** Given um novo modelo falha na suíte de ações e exposição de dados; when a release tenta promovê-lo **Expected:** o roteamento de produção não é alterado
...
Requirement IDs: FULL-024. Acceptance case IDs: FULL-ACC-024. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
