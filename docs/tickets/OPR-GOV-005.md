# OPR-GOV-005 - Obligation lifecycle
...
Track post-decision duties with owner, deadline, evidence of fulfillment and escalation; obligations are not permissions.
...
- **GOV-005.T01:** Create an obligation, fulfill it before deadline, and let another expire. **Expected:** One closes with evidence; the other escalates once with the correct owner/time.
- **GOV-005.T02:** Restart scheduler and revoke an assignee’s authority. **Expected:** Pending obligations survive and are reassigned/escalated through governed transitions.
...
Requirement IDs: GOV-005. Acceptance case IDs: GOV-005.T01, GOV-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
