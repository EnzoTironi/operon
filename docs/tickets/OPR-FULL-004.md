# OPR-FULL-004 - Semântica de referência
...
Manter interpretador e testes diferenciais do fragmento compilável.
...
- **FULL-ACC-004:** Given uma fixture produz estado conhecido no interpretador; when o backend executa a mesma transição pura **Expected:** os resultados e erros coincidem ou o build é bloqueado
...
Requirement IDs: FULL-004. Acceptance case IDs: FULL-ACC-004. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
