# OPR-RUL-003 - Open/closed world and verdict semantics
...
Declare missingness, explicit negative facts, review authority and priority for each predicate/rule.
...
- **RUL-003.T01:** Remove a fact under open- and closed-world declarations. **Expected:** Each yields its specified UNKNOWN/REVIEW/DENY semantics; no accidental negation-as-failure permission.
- **RUL-003.T02:** Reorder or combine hard-deny and discretionary rules. **Expected:** Declared priority remains explicit; contradictory rules yield a traceable conflict/disposition.
...
Requirement IDs: RUL-003. Acceptance case IDs: RUL-003.T01, RUL-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
