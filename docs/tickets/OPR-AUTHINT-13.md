# OPR-AUTHINT-13 - Build mandate and delegation UX
...
**Depends on:** OPR-AUTHINT-03, OPR-AUTHINT-07, OPR-AUTHINT-08
...
Show desired outcome, scope, limits, recipients and stop conditions; support standing mandates and safe useful autonomy, not prompts for every call.
