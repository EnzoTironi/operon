# OPR-MOD-003 - Bounded contexts and translations
...
Keep domain modules explicit, with pinned dependencies, a minimal shared kernel and reviewed boundary mappings.
...
- **MOD-003.T01:** Load a module with an incompatible interface/dependency version. **Expected:** Loading/release blocks with an actionable compatibility error.
- **MOD-003.T02:** Translate a status or identifier across two contexts with differing meanings. **Expected:** The mapping is versioned, tested and cannot silently equate unlike concepts.
...
Requirement IDs: MOD-003. Acceptance case IDs: MOD-003.T01, MOD-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
