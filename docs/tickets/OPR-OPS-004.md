# OPR-OPS-004 - Secrets and encryption controls
...
Protect transport, credential storage, backup material and sensitive configuration according to a reviewed deployment threat model.
...
- **OPS-004.T01:** Exercise success/error/tracing/export paths with marked secrets. **Expected:** No secret values in logs, errors, client bundles or artifacts.
- **OPS-004.T02:** Rotate credentials and inspect transport/storage/backup protection in the target environment. **Expected:** The configured protection and recovery behavior are verified, not inferred from a library choice.
...
Requirement IDs: OPS-004. Acceptance case IDs: OPS-004.T01, OPS-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
