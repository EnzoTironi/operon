# OPR-AUTHINT-09 - Make authorization part of atomic operations
...
Transactionally consume approval, reserve root budget, update state and record decision/outbox; preserve earlier audit atomicity requirements.
