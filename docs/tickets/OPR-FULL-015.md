# OPR-FULL-015 - Revogação e audiência
...
Revalidar autoridade e destino antes de emitir novos efeitos ou mensagens.
...
- **FULL-ACC-015:** Given o acesso de um agente foi revogado após planejar uma notificação; when o dispatcher tenta enviá-la **Expected:** a nova emissão é negada e nenhum conteúdo privado chega ao grupo
...
Requirement IDs: FULL-015. Acceptance case IDs: FULL-ACC-015. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
