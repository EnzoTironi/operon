# OPR-QRY-003 - OSS-equivalent query capabilities
...
Support load, filter, search, sort, page, aggregate and graph traversal using typed ontology contracts.
...
- **QRY-003.T01:** Run composite filters, pagination and aggregation against a hand-verified fixture. **Expected:** Results, counts, null handling and stable page ordering match the declared query semantics.
- **QRY-003.T02:** Submit invalid operators/types, deep recursive traversal and unbounded aggregation. **Expected:** Invalid requests fail; resource limits and continuation behavior are explicit.
...
Requirement IDs: QRY-003. Acceptance case IDs: QRY-003.T01, QRY-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
