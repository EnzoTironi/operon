# OPR-WW-001 - Domain model and physical relationship semantics
...
Implement plant/tank/blower/sensor/doser entities, telemetry/lab/effluent/alarm events, OperatingState, PermitVersion and decision dossiers.
...
- **WW-001.T01:** Load the chapter’s domain skeleton and shared Reviewable/Evidenced contracts. **Expected:** All required object categories and evidence/version relationships are queryable.
- **WW-001.T02:** Represent a recirculation loop and many-to-many doser relationships. **Expected:** Cycles are allowed for upstream_of and traversal remains bounded; the engine does not impose prerequisite semantics.
...
Requirement IDs: WW-001. Acceptance case IDs: WW-001.T01, WW-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
