# OPR-FULL-016 - Impedimento confidencial
...
Um avaliador pode bloquear sem revelar evidência confidencial.
...
- **FULL-ACC-016:** Given um impedimento existe fora da visão divulgável ao usuário; when o usuário solicita ação incompatível **Expected:** a ação é recusada com razão segura sem inferir ausência do impedimento
...
Requirement IDs: FULL-016. Acceptance case IDs: FULL-ACC-016. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
