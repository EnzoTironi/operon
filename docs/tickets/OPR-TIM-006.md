# OPR-TIM-006 - Explicit evidence-target binding
...
Resolve evidence through typed target references and declared relationship paths, not guessed parameter names.
...
- **TIM-006.T01:** Name the target basinRef rather than id/targetId/patientId and require sensor evidence. **Expected:** The same evidence guards run and block missing/stale data.
- **TIM-006.T02:** Supply another target’s otherwise fresh evidence IDs. **Expected:** The relationship/identity mismatch is rejected.
...
Requirement IDs: TIM-006. Acceptance case IDs: TIM-006.T01, TIM-006.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
