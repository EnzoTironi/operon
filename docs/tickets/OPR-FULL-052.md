# OPR-FULL-052 - Verificador independente
...
O agente implementador não pode aprovar o próprio resultado nem remover testes protegidos.
...
- **FULL-ACC-052:** Given o agente apaga cenário adversarial para obter verde; when o verificador avalia o diff **Expected:** a mudança é recusada independentemente dos testes restantes
...
Requirement IDs: FULL-052. Acceptance case IDs: FULL-ACC-052. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
