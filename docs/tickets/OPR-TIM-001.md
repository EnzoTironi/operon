# OPR-TIM-001 - Valid and transaction time
...
Distinguish when a fact applied from when the system learned it, including late corrections.
...
- **TIM-001.T01:** Record a sample taken at t1 but reported at t2, then correct it at t3. **Expected:** Valid-time and known-at queries return different, correct views.
- **TIM-001.T02:** Exercise adjacent, overlapping, open-ended and retroactive intervals. **Expected:** Declared interval semantics avoid accidental overlap or loss; unsupported shapes reject explicitly.
