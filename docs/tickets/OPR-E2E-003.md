# OPR-E2E-003 - Mutation and adversarial regression strength
...
Verify that intentionally broken enforcement is detected by the acceptance suite.
...
- **E2E-003.T01:** Remove auth, skip a guard, accept an approval flag, ignore audit failure or omit outbox persistence. **Expected:** Each mutation causes a relevant acceptance test to fail.
- **E2E-003.T02:** Change > to >=, change rule priority and remove a version/evidence dependency. **Expected:** Boundary/priority/temporal tests detect semantic drift; surviving mutants are reviewed, not hidden.
...
Requirement IDs: E2E-003. Acceptance case IDs: E2E-003.T01, E2E-003.T02, BAI-055, BAI-056, BAI-057, BAI-058, BAI-059, BAI-060. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
