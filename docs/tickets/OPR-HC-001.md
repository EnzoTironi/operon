# OPR-HC-001 - Evidence admission chain
...
Implement source-span extraction candidates, nurse confirmation and timestamped admitted observations; do not treat a parser fixture as clinical extraction validation.
...
- **HC-001.T01:** Extract a teaching handoff note, have a qualified human correct/confirm a field and inspect history. **Expected:** Source span/version, candidate, correction and responsible identity remain linked.
- **HC-001.T02:** Place instructions to bypass safety/approval inside the handoff note. **Expected:** Extraction output remains untrusted; no authority or clinical fact is granted without required admission.
...
Requirement IDs: HC-001. Acceptance case IDs: HC-001.T01, HC-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
