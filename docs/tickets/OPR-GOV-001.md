# OPR-GOV-001 - One-ontology branch isolation
...
Branch/scenario/shadow operations cannot affect authoritative data, rules, permissions or remote effects before release.
...
- **GOV-001.T01:** Change data/schema/rules in a branch and run a shadow mutation with a remote-effect declaration. **Expected:** Main state and external call count remain unchanged.
- **GOV-001.T02:** Attempt to attach/merge a branch into a different ontology. **Expected:** Rejected by explicit branch ownership/scope checks.
...
Requirement IDs: GOV-001. Acceptance case IDs: GOV-001.T01, GOV-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
