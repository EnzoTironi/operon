# OPR-SCN-018 - Reset, clone and export cannot launder provenance
...
Cloning, import/export and restart preserve environment, ancestry, data restrictions and simulated-effect labels; a new scenario is not a mechanism to reset cumulative tenant quotas or authority.
...
- **SCN-018.T01:** Clone/export/import a scenario with new and deleted objects, invalid runs and hypothetical evidence. **Expected:** Ancestry and labels remain intact; independent audits persist and the new working identity is explicit.
- **SCN-018.T02:** Strip ancestry on import, replay old side-effect receipts or repeatedly clone to evade quota. **Expected:** Import is quarantined or rejected; shared budgets and delivery authorization prevent laundering.
...
Requirement IDs: SCN-018. Acceptance case IDs: SCN-018.T01, SCN-018.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
