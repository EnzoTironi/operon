# OPR-RUL-002 - Snapshot-to-fact mapping
...
Generate typed facts, value-domain constraints, relationships, closure declarations and pinned rule versions from relevant evidence.
...
- **RUL-002.T01:** Translate a fixture with types, properties, interfaces, links and versions. **Expected:** All required dependency facts map with consistent identities and types; omitted dependencies fail validation.
- **RUL-002.T02:** Evaluate a decision needing a small subgraph from a larger tenant database. **Expected:** Only necessary permitted facts are exported; snapshot and rule bindings are recorded.
...
Requirement IDs: RUL-002. Acceptance case IDs: RUL-002.T01, RUL-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
