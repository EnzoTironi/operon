# OPR-AUTHINT-14 - Govern identity and software control planes
...
**Depends on:** OPR-AUTHINT-03, OPR-AUTHINT-08
...
Protect role/provider/client/key configuration and grant mutations; builder cannot change its own policy or certify its own release.
