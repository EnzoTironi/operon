# OPR-FULL-011 - Exatidão versus relevância
...
Consultas totais não devem usar top-k semântico como universo exaustivo.
...
- **FULL-ACC-011:** Given existem mais registros correspondentes que a janela semântica; when o usuário pede a contagem total **Expected:** a consulta exata calcula o universo autorizado e reporta cobertura
...
Requirement IDs: FULL-011. Acceptance case IDs: FULL-ACC-011. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
