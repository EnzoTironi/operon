# OPR-FULL-054 - Autohospedagem controlada
...
A plataforma deve construir pacotes seus sem controlar a própria raiz de publicação.
...
- **FULL-ACC-054:** Given a factory gera alteração de seu executor; when o pipeline tenta publicá-la **Expected:** o gate externo e sua política vigente continuam obrigatórios
...
Requirement IDs: FULL-054. Acceptance case IDs: FULL-ACC-054. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
