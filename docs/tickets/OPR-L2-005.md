# OPR-L2-005 - Separate extraction and human admission
...
Separate extracted candidates from admitted evidence; retain source span, edits, timestamps and human confirmation.
...
- **L2-005.T01:** Create an unconfirmed extraction candidate and evaluate an action requiring its fact. **Expected:** The candidate is not treated as authoritative evidence.
- **L2-005.T02:** A permitted human edits and confirms the candidate; inspect later. **Expected:** Original extraction, edited value, source version/span and both actor roles remain linked.
...
Requirement IDs: L2-005. Acceptance case IDs: L2-005.T01, L2-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
