...
UI deve separar estado aceito, proposta e evidência.
...
- **FULL-ACC-035:** Given uma conversa propõe prazo diferente; when o cartão do projeto é aberto **Expected:** o prazo vigente e a proposta aparecem como estados distintos
...
Requirement IDs: FULL-035. Acceptance case IDs: FULL-ACC-035. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
