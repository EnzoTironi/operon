# OPR-REL-002 - Cardinality and cycle policy
...
Enforce 1:1, 1:N, M:N and domain-specific cycle constraints under concurrent writes.
...
- **REL-002.T01:** Race two links that together violate the declared maximum cardinality. **Expected:** Only a valid committed relation set remains.
- **REL-002.T02:** Add a prerequisite cycle and a recirculation cycle in their respective domain types. **Expected:** The prerequisite cycle is rejected; allowed recirculation traversals terminate without hiding reachable nodes.
...
Requirement IDs: REL-002. Acceptance case IDs: REL-002.T01, REL-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
