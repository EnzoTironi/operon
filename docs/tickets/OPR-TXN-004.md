# OPR-TXN-004 - Predicate and evidence concurrency
...
Guard read sets include relationships, aggregates and absence checks; per-object revision checks alone are insufficient.
...
- **TXN-004.T01:** With one waiver slot left, race two different request objects for the same student/programme. **Expected:** At most one new approval commits; the cross-object cap is preserved.
- **TXN-004.T02:** Insert a contraindication, active competing proposal or changed permission link after guard evaluation but before commit. **Expected:** The transaction detects/revalidates the changed predicate or uses sufficient isolation; unsafe action cannot commit.
...
Requirement IDs: TXN-004. Acceptance case IDs: TXN-004.T01, TXN-004.T02, BAI-031, BAI-032, BAI-033, BAI-034, BAI-035, BAI-036, BAI-037, BAI-038, BAI-039, BAI-040, BAI-041, BAI-042. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
