# OPR-MOD-002 - Shared asset governance
...
Track unique ownership, consumers, impact analysis, review and deprecation of shared properties/value types.
...
- **MOD-002.T01:** Change a shared type used by a rule and field-level policy. **Expected:** Both consumers appear in impact analysis and required approvals.
- **MOD-002.T02:** Deprecate and replace an asset referenced by historical decisions. **Expected:** Active consumers migrate deliberately; historical definitions remain available.
...
Requirement IDs: MOD-002. Acceptance case IDs: MOD-002.T01, MOD-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
