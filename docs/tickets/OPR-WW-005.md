# OPR-WW-005 - Writeback, alarms and reconciliation
...
Use idempotent DCS writeback, explicit rejection, notifications, compensation and hourly reconciliation in the teaching configuration.
...
- **WW-005.T01:** Reject the command, lose an acknowledgment and create an actual-setpoint mismatch. **Expected:** No false issued state; uncertain commitments and reconciliation items remain visible.
- **WW-005.T02:** Create correlated upstream alarms and recovery/limit alarms. **Expected:** Declared causal grouping and graded routing operate; non-safety optimization pauses during storm mode.
...
Requirement IDs: WW-005. Acceptance case IDs: WW-005.T01, WW-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
