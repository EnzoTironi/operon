# OPR-ACT-005 - Safe alternatives and evidence completion
...
A failed proposal may yield a separately validated alternative, request for evidence or human review; never execute an alternative silently.
...
- **ACT-005.T01:** Fail a calibration/evidence requirement and request a replacement action. **Expected:** An explicit new proposal with its own parameters and authority is shown.
- **ACT-005.T02:** Admit requested evidence and revive the original intent. **Expected:** Revalidation runs on new evidence; any required new approval binds that revised basis.
...
Requirement IDs: ACT-005. Acceptance case IDs: ACT-005.T01, ACT-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
