...
Define precedence among source updates, user edits and derived values rather than last-writer-wins by accident.
...
- **ING-002.T01:** Race a source refresh with an authorized protected field edit. **Expected:** Declared precedence or explicit conflict handling wins without silent loss.
- **ING-002.T02:** End a temporary override and apply new source data. **Expected:** Authority transition is auditable and future updates follow the intended source rule.
...
Requirement IDs: ING-002. Acceptance case IDs: ING-002.T01, ING-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
