# OPR-HC-003 - Temporal and completeness boundaries
...
Test same-day/local-calendar semantics, exactly four-hour freshness, coverage and changes before confirmation.
...
- **HC-003.T01:** Use evidence just before midnight, time-zone transitions and exactly at/above four hours. **Expected:** Configured same-day and closed freshness semantics both apply; UTC date alone is not silently assumed.
- **HC-003.T02:** Add new readings after supplementation/approval. **Expected:** Current guards rerun and the revived proposal cites the new versioned evidence.
...
Requirement IDs: HC-003. Acceptance case IDs: HC-003.T01, HC-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
