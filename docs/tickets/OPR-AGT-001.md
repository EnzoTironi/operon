...
Implement chat/decision/action workflows and distinguish Observe, Propose, Execute with approval and Bounded autonomy.
...
- **AGT-001.T01:** Exercise every tier against read, propose, approve, execute and administer operations. **Expected:** Tier 1 reads; tier 2 proposes for human execution; tier 3 executes as agent only after human approval; tier 4 stays in its approved envelope.
- **AGT-001.T02:** Complete the same business action under tiers 2 and 3. **Expected:** Tier 2 human execution and tier 3 agent execution have distinct actor/confirmation records.
...
Requirement IDs: AGT-001. Acceptance case IDs: AGT-001.T01, AGT-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
