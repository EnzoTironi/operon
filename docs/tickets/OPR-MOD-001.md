# OPR-MOD-001 - Three-part interface conformance
...
Validate property, link and action-mapping commitments for every implementing type.
...
- **MOD-001.T01:** Omit a required property, evidence link or abstract-action mapping. **Expected:** Schema compilation fails rather than accepting a nominal implements label.
- **MOD-001.T02:** Use one Reviewable inbox and rule across waiver and setpoint requests. **Expected:** Domain-specific mappings preserve shared status and review semantics.
...
Requirement IDs: MOD-001. Acceptance case IDs: MOD-001.T01, MOD-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
