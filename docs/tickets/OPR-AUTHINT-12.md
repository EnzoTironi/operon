# OPR-AUTHINT-12 - Integrate revocation with workers and recovery
...
**Depends on:** OPR-AUTHINT-04, OPR-AUTHINT-09
...
Recheck current epochs before external issue; preserve unknown outcomes, reconciliation and legitimate organization handover; measure stale bounds.
