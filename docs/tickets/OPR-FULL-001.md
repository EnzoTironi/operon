# OPR-FULL-001 - Tipos, unidades e efeitos
...
O compilador deve rejeitar composição incompatível de tipos, unidades ou classes de efeito.
...
- **FULL-ACC-001:** Given uma expressão soma dinheiro em moedas diferentes sem conversão; when o pacote é compilado **Expected:** o compilador rejeita com diagnóstico tipado e não publica artefato executável
...
Requirement IDs: FULL-001. Acceptance case IDs: FULL-ACC-001. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
