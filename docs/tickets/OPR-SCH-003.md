# OPR-SCH-003 - Value Types and Shared Properties
...
Register semantic domains, units, validators, owner and reusable shared-property definitions.
...
- **SCH-003.T01:** Supply incompatible units or a value outside a semantic domain. **Expected:** Reject unless an explicit versioned conversion exists; do not reinterpret a naked number.
- **SCH-003.T02:** Reference one shared property across types, rules and interfaces, then propose a breaking change. **Expected:** Consumers are discoverable and blocked/migrated under governed review.
...
Requirement IDs: SCH-003. Acceptance case IDs: SCH-003.T01, SCH-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
