# OPR-AGT-002 - Bounded autonomy and earned promotion
...
Bind autonomy to action class × Object Set × risk band, with shadow/calibration evidence and demotion triggers.
...
- **AGT-002.T01:** Try an allowed action outside the object set/risk band, and an unlisted action inside it. **Expected:** All out-of-envelope combinations fail.
- **AGT-002.T02:** Promote without required reports, then simulate a declared deterioration trigger. **Expected:** Unjustified promotion blocks; a governed demotion reduces future authority and is audited.
...
Requirement IDs: AGT-002. Acceptance case IDs: AGT-002.T01, AGT-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
