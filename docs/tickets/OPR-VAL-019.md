# OPR-VAL-019 - Audit anchoring and completeness
...
A hash-chain check must state its trusted checkpoint, expected completeness and limitations; local recomputation is not proof against authorized truncation or wholesale replacement.
...
- **VAL-019.T01:** Remove tail records or replace the whole local chain **Expected:** Protected checkpoint/completeness check detects tampering
- **VAL-019.T02:** Verify intact chain and permitted redacted export **Expected:** Integrity claim states preserved and unavailable evidence precisely
...
Requirement IDs: VAL-019. Acceptance case IDs: VAL-019.T01, VAL-019.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
