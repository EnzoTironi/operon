# OPR-RUL-004 - VerificationRecord and proof trace
...
Retain input snapshot, rule version, verdict, reasons, trace and engine version for each adjudication.
...
- **RUL-004.T01:** Reload an old snapshot/rule engine version after a policy release. **Expected:** The original verdict and trace can be reproduced within the declared engine semantics.
- **RUL-004.T02:** Change a cited rule/input or fabricate a trace step. **Expected:** Verification rejects invalid proof references or labels unverifiable content.
...
Requirement IDs: RUL-004. Acceptance case IDs: RUL-004.T01, RUL-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
