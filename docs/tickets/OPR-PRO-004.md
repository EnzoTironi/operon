# OPR-PRO-004 - Exact independent approval without reviewer impersonation
...
Promotion requires the policy-specified distinct human or explicitly authorized release service; sentinel and proposer cannot satisfy a human-review requirement.
...
- **PRO-004.T01:** Have an authorized independent reviewer approve the exact manifest after sentinel and deterministic review. **Expected:** The review identities and scope are retained separately from the scenario author and runtime executor.
- **PRO-004.T02:** Approve with a sentinel account, copied scenario role, tool-supplied human identity or a revoked reviewer. **Expected:** Production promotion remains blocked.
...
Requirement IDs: PRO-004. Acceptance case IDs: PRO-004.T01, PRO-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
