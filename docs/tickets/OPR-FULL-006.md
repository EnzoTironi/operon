# OPR-FULL-006 - Afirmações e autoridade
...
Afirmações conflitantes devem coexistir; admissão exige política responsável por atributo.
...
- **FULL-ACC-006:** Given uma conversa contradiz um registro contratual vigente; when o extrator ingere a conversa **Expected:** uma afirmação contestável é criada sem sobrescrever o compromisso aceito
...
Requirement IDs: FULL-006. Acceptance case IDs: FULL-ACC-006. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
