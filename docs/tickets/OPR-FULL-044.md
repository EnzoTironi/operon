# OPR-FULL-044 - Compartilhamento seletivo
...
Federação deve exportar somente visão aprovada e sua proveniência.
...
- **FULL-ACC-044:** Given duas empresas compartilham status de pedido; when o receptor tenta percorrer links privados **Expected:** a navegação fora do contrato é negada
...
Requirement IDs: FULL-044. Acceptance case IDs: FULL-ACC-044. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
