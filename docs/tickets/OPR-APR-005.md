# OPR-APR-005 - One-time durable consumption
...
Consume execution authorization with the complete action commit, including competing approvers/processes.
...
- **APR-005.T01:** Two independent processes attempt to execute using the same approved proposal. **Expected:** At most one logical execution commits; the other recovers the result or conflicts.
- **APR-005.T02:** Fail before commit after claiming the approval. **Expected:** The approval is not permanently consumed alone; retry follows explicit lifecycle rules.
...
Requirement IDs: APR-005. Acceptance case IDs: APR-005.T01, APR-005.T02, BAI-037, BAI-038, BAI-039, BAI-040, BAI-041, BAI-042. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
