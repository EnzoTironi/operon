# OPR-UX-002 - Approval and override interaction
...
Show readiness beside confidence, action diffs and current evidence; support modification/revalidation and low-friction accountable rejection.
...
- **UX-002.T01:** Edit a proposed value in the reviewer UI. **Expected:** The new proposal is revalidated/rebound; old signatures do not silently authorize the modification.
- **UX-002.T02:** Record each override category and check disposition feedback. **Expected:** Reason, signature and alternative are retained; the interface does not frame legitimate judgment as misconduct.
...
Requirement IDs: UX-002. Acceptance case IDs: UX-002.T01, UX-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
