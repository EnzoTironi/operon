# OPR-FULL-008 - Remoção e derivação
...
Propagar exclusão/restrição para todos os derivados previstos pelo perfil.
...
- **FULL-ACC-008:** Given uma evidência foi retirada conforme política de retenção; when memória e pesquisa são consultadas **Expected:** conteúdo derivado proibido não retorna e o limite de replay fica explícito
...
Requirement IDs: FULL-008. Acceptance case IDs: FULL-ACC-008. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
