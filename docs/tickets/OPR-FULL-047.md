# OPR-FULL-047 - Células e fencing
...
Migração/failover devem preservar autoridade única de escrita.
...
- **FULL-ACC-047:** Given dois processos acreditam servir o mesmo tenant após falha; when ambos tentam despachar efeitos **Expected:** apenas o detentor do fence vigente pode emitir novos efeitos
...
Requirement IDs: FULL-047. Acceptance case IDs: FULL-ACC-047. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
