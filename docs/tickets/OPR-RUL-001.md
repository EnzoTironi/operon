# OPR-RUL-001 - Real symbolic verifier
...
Implement/version the selected symbolic engine and fact mapping; a simplified interpreter must disclose its supported fragment.
...
- **RUL-001.T01:** Run the domain rule suite through the real registered engine and record engine/version. **Expected:** Verdicts and reasons are reproducible; no mock is counted as a Prolog integration.
- **RUL-001.T02:** Submit recursion/negation/cut/priority constructs beyond the declared fragment. **Expected:** Reject explicitly; do not approximate silently and claim full semantics.
...
Requirement IDs: RUL-001. Acceptance case IDs: RUL-001.T01, RUL-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
