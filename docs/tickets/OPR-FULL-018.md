# OPR-FULL-018 - Resultado desconhecido
...
Tratar timeout externo como desconhecido até reconciliação.
...
- **FULL-ACC-018:** Given a origem confirmou internamente mas a resposta foi perdida; when o worker recebe timeout **Expected:** a operação não é reenviada cegamente e a consulta de resultado é agendada
...
Requirement IDs: FULL-018. Acceptance case IDs: FULL-ACC-018. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
