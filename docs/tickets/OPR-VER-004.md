# OPR-VER-004 - Branch isolation and internal atomicity proofs
...
Define and verify the modeled branch-isolation and ontology-internal atomicity properties.
...
- **VER-004.T01:** Introduce a shadow write to main or partial-commit transition. **Expected:** The verifier detects the violation in the formal model.
- **VER-004.T02:** Pair proof obligations with actual branch and fault-injection tests. **Expected:** Both are reported separately; a proof of an abstract model does not certify unmodeled adapter code.
...
Requirement IDs: VER-004. Acceptance case IDs: VER-004.T01, VER-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
