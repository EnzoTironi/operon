# OPR-FULL-005 - Identidade reversível
...
A fusão e posterior separação de identidades deve preservar origem e referências históricas.
...
- **FULL-ACC-005:** Given duas organizações foram fundidas por erro; when a fusão é desfeita **Expected:** registros são separados sem perder referências às decisões anteriores
...
Requirement IDs: FULL-005. Acceptance case IDs: FULL-ACC-005. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
