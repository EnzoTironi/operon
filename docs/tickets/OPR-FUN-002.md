# OPR-FUN-002 - Staged edit discipline
...
Edit functions stage ontology changes only and are invoked through governed actions; external effects are declared separately.
...
- **FUN-002.T01:** Stage several edits and then fail. **Expected:** No staged object or link becomes visible.
- **FUN-002.T02:** Try invoking write logic directly or issuing undeclared remote side effects within staging. **Expected:** Capability isolation or policy blocks the path; violations fail tests and cannot ship.
...
Requirement IDs: FUN-002. Acceptance case IDs: FUN-002.T01, FUN-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
