# OPR-HC-006 - Feedback, presentation and qualified validation
...
Route the five override classes, retain displayed evidence and separate teaching tests from clinical deployment acceptance.
...
- **HC-006.T01:** Record missing evidence/outdated rule/out-of-scope/contextual/other overrides and dispositions. **Expected:** Each has an accountable owner and trace to governed changes; other is not an unowned bucket.
- **HC-006.T02:** Review the actual data sources, rule authority, clinical workflow and independent safety evaluation before clinical deployment. **Expected:** Synthetic passing fixtures are not labeled treatment validity or regulatory approval.
...
Requirement IDs: HC-006. Acceptance case IDs: HC-006.T01, HC-006.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
