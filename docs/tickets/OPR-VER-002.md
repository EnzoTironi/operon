# OPR-VER-002 - V-EDO component and semantics coverage
...
Represent T,I,L,S,R,F,A,P,E,V and the action tuple with compensation, preserving explicit type, time, evidence and obligation meaning.
...
- **VER-002.T01:** Map formal symbols to executable models and data structures. **Expected:** Every component has defined semantics and traceability, not a name-only class.
- **VER-002.T02:** Compare the formal transition interpreter with the actual action runtime on a shared corpus. **Expected:** Differences surface as model/runtime fidelity defects rather than being hidden by abstraction.
...
Requirement IDs: VER-002. Acceptance case IDs: VER-002.T01, VER-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
