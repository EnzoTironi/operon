# OPR-VAL-014 - Protected historical regression retention
...
Carry every prior finding into exact current-source regression mapping; unchanged source does not close a defect and a narrow repaired example does not replace a broader invariant.
...
- **VAL-014.T01:** Rerun CR-01 through CR-14 and original focused cases with actual dependencies **Expected:** Each result states candidate, scope, entrypoint and evidence level
- **VAL-014.T02:** Intentionally reintroduce known rejection/SQL/approval defects **Expected:** Independent regression cases detect the targeted defect
...
Requirement IDs: VAL-014. Acceptance case IDs: VAL-014.T01, VAL-014.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
