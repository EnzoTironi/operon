# OPR-APR-003 - Segregation, quorum and exact capabilities
...
Verify distinct authorized reviewers, required countersignatures and contextual conflict exclusions.
...
- **APR-003.T01:** Attempt requester approval and repeated approvals by aliases of the same principal. **Expected:** Neither satisfies an independent-review/quorum requirement.
- **APR-003.T02:** Test below, at and above escalation thresholds with insufficient and sufficient distinct reviewers. **Expected:** Only the explicitly authorized quorum satisfies the action’s approval policy.
...
Requirement IDs: APR-003. Acceptance case IDs: APR-003.T01, APR-003.T02, BAI-031, BAI-032, BAI-033, BAI-034, BAI-035, BAI-036. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
