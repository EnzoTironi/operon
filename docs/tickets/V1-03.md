...
- [ ] client-supplied tenant/role cannot elevate authority.
- [ ] aggregate-use budget exhaustion denies or requires review.
- [ ] result is exactly ALLOW, DENY, REVIEW_REQUIRED or EVIDENCE_INSUFFICIENT; infra failure is separate.
