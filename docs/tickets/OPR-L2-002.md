# OPR-L2-002 - Complete output for a declared question
...
Compare outputs against a versioned must-answer/required-evidence template.
...
- **L2-002.T01:** Remove a required fact, uncertainty, contraindication or missing-evidence warning from an otherwise correct output. **Expected:** Completeness fails with the omitted requirement identified.
- **L2-002.T02:** Reuse an answer template for a different decision/question scope. **Expected:** The appropriate must-answer set is selected; absent requirements are not inferred from confidence.
...
Requirement IDs: L2-002. Acceptance case IDs: L2-002.T01, L2-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
