# OPR-FULL-042 - Transferência de autoridade
...
Migração de sistema deve cercar escritores anteriores e reconciliar saldo/estado.
...
- **FULL-ACC-042:** Given um processo muda de autoridade externa para local; when o escritor antigo tenta atualizar após o corte **Expected:** o update é rejeitado/quarentenado segundo o protocolo e não desfaz o corte
...
Requirement IDs: FULL-042. Acceptance case IDs: FULL-ACC-042. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
