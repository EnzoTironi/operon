...
- [ ] CLI/MCP/SDK call the same service and return equivalent semantics.
- [ ] stdout stays machine-readable and secrets are redacted.
- [ ] diagnostics distinguish business result, policy result and infrastructure failure.
