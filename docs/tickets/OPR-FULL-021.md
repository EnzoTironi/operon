# OPR-FULL-021 - Objetivos verificáveis
...
Missões devem definir sucesso por predicados observáveis e restrições obrigatórias.
...
- **FULL-ACC-021:** Given o modelo declara missão concluída mas a operação segue pendente; when o avaliador checa o estado **Expected:** a missão permanece parcial ou pendente sem sucesso fictício
...
Requirement IDs: FULL-021. Acceptance case IDs: FULL-ACC-021. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
