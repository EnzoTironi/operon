# OPR-EFF-008 - Structured concurrency and backpressure
...
Scope child fibers and bound parallel workers, queues and streams to declared resource limits.
...
- **EFF-008.T01:** Run a recurring worker, close its parent scope and advance time. **Expected:** No further work or orphan fibers remain; in-flight work has a recorded disposition.
- **EFF-008.T02:** Feed a producer faster than the consumer for a sustained burst. **Expected:** Backpressure/rejection follows a declared policy; bounded memory and no silently lost accepted events.
...
Requirement IDs: EFF-008. Acceptance case IDs: EFF-008.T01, EFF-008.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
