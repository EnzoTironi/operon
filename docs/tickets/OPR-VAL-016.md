# OPR-VAL-016 - Cross-interface contract conformance
...
HTTP, CLI, MCP, SDK and UI must share authorization, query, preparation and operation semantics; no interface can bypass checks enforced elsewhere.
...
- **VAL-016.T01:** Repeat the same authorized and denied operation through every shipped interface **Expected:** Equivalent semantic results and authorized disclosures
- **VAL-016.T02:** Try direct object write, fabricated human identity and readiness metadata routes **Expected:** Bypasses are denied or explicitly limited to qualified maintenance/demo mode
...
Requirement IDs: VAL-016. Acceptance case IDs: VAL-016.T01, VAL-016.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
