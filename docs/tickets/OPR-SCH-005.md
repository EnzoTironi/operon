# OPR-SCH-005 - Lifecycle and object categories
...
Support entity, event, state and decision-record semantics; archive before deletion and preserve accountable history.
...
1. Resolve and freeze the relevant S02 contract; retain existing source vocabulary and open decisions.
...
- **SCH-005.T01:** Attempt in-place edits of historical events and decision records. **Expected:** They are rejected; authorized corrections append explicit new records.
- **SCH-005.T02:** Archive an entity, then exercise a dedicated authorized deletion/redaction policy. **Expected:** Default views exclude archived objects; retained audit/tombstone behavior follows the declared retention policy without retaining prohibited content.
...
Requirement IDs: SCH-005. Acceptance case IDs: SCH-005.T01, SCH-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
