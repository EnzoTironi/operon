# OPR-REL-005 - Contradiction visibility
...
Detect declared inter-object inconsistencies without concealing unresolved disagreement.
...
- **REL-005.T01:** Ingest conflicting state values with different provenance. **Expected:** A visible conflict record and policy-defined adjudication path are produced.
- **REL-005.T02:** Change a dependency of a consistency rule. **Expected:** The affected consistency status updates; untouched conflicts do not disappear.
...
Requirement IDs: REL-005. Acceptance case IDs: REL-005.T01, REL-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
