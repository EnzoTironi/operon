# OPR-FUN-006 - Rules retain final authority
...
Model scores and free-text explanations cannot replace deterministic red lines, admission or approval rules.
...
- **FUN-006.T01:** Provide a highly favorable score for a known forbidden action. **Expected:** The hard rule denies; explanation text cannot override the verdict.
- **FUN-006.T02:** Attach observed outcomes to past predictions and calculate calibration/override indicators. **Expected:** Metrics use real or explicitly simulated observations with denominators and version lineage; no fabricated field validity.
...
Requirement IDs: FUN-006. Acceptance case IDs: FUN-006.T01, FUN-006.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
