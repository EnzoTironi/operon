# OPR-AUTHINT-10 - Guard all reads and metadata
...
**Depends on:** OPR-AUTHINT-07, OPR-AUTHINT-08
...
Mandatory shared query/explain/readiness/inbox/search/export checks, push-down filters and aggregate confidentiality; remove optional enforcement paths.
