...
Todo resultado formal deve explicitar fragmento, hipóteses, versões e bound quando usado.
...
- **FULL-ACC-026:** Given um solver não encontra contraexemplo até profundidade K; when o relatório é publicado **Expected:** o resultado é bounded_no_counterexample e não prova ilimitada
...
Requirement IDs: FULL-026. Acceptance case IDs: FULL-ACC-026. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
