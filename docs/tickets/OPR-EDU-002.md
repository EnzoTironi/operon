# OPR-EDU-002 - Waiver cap and grade boundaries
...
Enforce at most two approved waivers per student/programme and the stated equivalent-grade threshold.
...
- **EDU-002.T01:** Approve with zero/one prior approvals, reject with two; race two candidates when one slot remains. **Expected:** The total cap is preserved, including concurrency and separate programmes.
- **EDU-002.T02:** Use just below 60, exactly 60 and above 60 in the designated version. **Expected:** Below denies; exactly 60 passes this rule, subject to all other rules.
...
Requirement IDs: EDU-002. Acceptance case IDs: EDU-002.T01, EDU-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
