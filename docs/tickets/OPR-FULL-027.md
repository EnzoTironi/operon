# OPR-FULL-027 - Equivalência e contraexemplo
...
Converter divergências de tradução em testes reprodutíveis.
...
- **FULL-ACC-027:** Given backend e interpretador divergem numa regra; when a suíte diferencial roda **Expected:** a publicação é bloqueada com fixture de contraexemplo
...
Requirement IDs: FULL-027. Acceptance case IDs: FULL-ACC-027. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
