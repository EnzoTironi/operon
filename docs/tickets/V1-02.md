...
- [ ] conflicting evidence remains attributed and unresolved.
- [ ] valid-time correction does not rewrite transaction history.
- [ ] independent SQL/oracle matches API result.
