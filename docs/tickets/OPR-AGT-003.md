...
Runtime consumers cannot change governing definitions; builders use isolated development resources without direct production-data authority.
...
Requirement IDs: AGT-003. Acceptance case IDs: AGT-003.T01, AGT-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
