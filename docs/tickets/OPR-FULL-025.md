# OPR-FULL-025 - 4C de estado e saída
...
Distinguir fidelidade ao contexto de correção do estado e exigir ambos conforme o perfil de decisão.
...
- **FULL-ACC-025:** Given uma resposta fiel cita contexto cuja evidência obrigatória está vencida; when a missão verifica readiness e qualidade da saída **Expected:** a fidelidade da resposta não autoriza a ação com estado inadequado
...
Requirement IDs: FULL-025. Acceptance case IDs: FULL-ACC-025. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
