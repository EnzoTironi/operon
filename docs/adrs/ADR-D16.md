# ADR-D16 - Initial release profile and first live workflow
...
A full future product contract is not a commitment that every domain or research proof ships in its first release.

## Decision / required resolution

V0 is the initial release profile: agent-agnostic public CLI/MCP substrate, zero permanent UI, skills/recipes, V0-A through V0-F, protected Company-in-a-Box plus one eligible real-company mirror. Maximum scope remains post-V0.
