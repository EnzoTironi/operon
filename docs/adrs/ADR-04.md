...
Separate evidence, claim, admitted state and confirmed effect.

## Context and trade-off

Extracted assertions must not implicitly rewrite approved records.
...
Conflict, authority, identity split/merge, correction and retraction tests.
