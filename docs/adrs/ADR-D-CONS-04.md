# ADR-D-CONS-04 - CLI privilege profiles
...
Separate explicit synthetic demo and audited maintenance from authenticated production; forbid identity-minting flags in production.

## Decision / required resolution

Profiles are explicit: synthetic demo, audited maintenance, authenticated production and authenticated external-agent. No client flag or MCP argument mints identity, role, tier, mandate or grant.
