# ADR-D10 - Performance, topology and availability targets
...
The documents and accessibility goal do not specify hardware, dataset distribution, traffic, latency percentiles, recovery objectives or supported distributed topology.

## Decision / required resolution

Record workload, environment, SLOs, RPO/RTO, retention and intended target deployments before performance/failover acceptance. Report measurements and limits; no universal everyone-scale or zero-downtime assertion.
