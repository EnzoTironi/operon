# ADR-D-V0-DIST-01 - Initial OSS distribution and protected material
...
This decision governs the stated Operon contract boundary.

## Decision / required resolution

For V0, kernel/contracts/skills/recipes are OSS distribution; Company-in-a-Box gold, hidden cases, oracles, thresholds, private weights/evaluator material and company data remain private. Exact license, ownership details and any future closure model remain open under D-V0-LICENSE-01.
