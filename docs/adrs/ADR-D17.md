# ADR-D17 - Scenario data retention, sharing and model processing
...
Copied sensitive data, revoked access, retained audits and model-provider processing require an explicit handling policy.

## Decision / required resolution

Review and approve an explicit versioned contract; the proposed default is not recorded as approved.
