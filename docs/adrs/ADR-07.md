...
PreparedAction plus independent approval binds the exact release, evidence and plan.

## Context and trade-off

Approval is not an editable boolean and preparation must not execute business effects.
...
Stale-state, altered handler, changed parameters, actor reuse and atomic consumption tests.
