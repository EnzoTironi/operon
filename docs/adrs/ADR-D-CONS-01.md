# ADR-D-CONS-01 - Canonical terminology
...
Use TaskMandate for authorized goal, IntentGrant for delegated capacity, WorldView for pinned observation and PreparedAction for exact intended effects; add compatibility mappings instead of silently renaming source fields.

## Decision / required resolution

Canonical vocabulary: TaskMandate authorized outcome; IntentGrant delegated capacity; WorldView pinned observation context; PreparedAction exact intended effects; DefinitionRelease immutable executable semantics; ChangeSet reviewable definition change. Preserve compatibility aliases.
