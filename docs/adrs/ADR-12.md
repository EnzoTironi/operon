...
Memory and models remain replaceable; untrusted code runs across a qualified isolation boundary.

## Context and trade-off

Graphiti and callbacks provide useful functions, but neither is automatically authoritative or isolated.
...
Source-bound retrieval, privacy propagation, unavailable dependency and host-capability denial.
