...
Protect case catalogue, oracles, runner and release policy outside the candidate workspace.

## Context and trade-off

A self-authored green manifest cannot close a ticket.
...
Evidence-gate mutation cases, signature/key custody, artifact snapshot and independent release review.
