...
Versioned declarative definitions compile to a typed IR; executable action releases are immutable.

## Context and trade-off

UI, CLI, MCP, policy and tests should share meaning rather than duplicate it.
...
Independent interpreter/compiler comparisons; action changes invalidate incompatible approval.
