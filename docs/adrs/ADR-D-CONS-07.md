# ADR-D-CONS-07 - Normative contract publication
...
Approve candidate schemas and service contracts after resolving affected source decisions; do not resolve illustrative regulated-domain comparators by default.
