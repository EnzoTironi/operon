# ADR-D-V0-BUSINESS-01 - Business model and commercial evidence
...
**Status:** OPEN  
**Applicability:** NON_BLOCKING_V0

## Context

Discover buyer, offer, hosting/services, pricing unit and willingness to pay. Does not block V0 engineering or dual proof. Blocks resolved pricing, packaging and revenue claims.
