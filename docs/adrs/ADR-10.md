...
Scenarios carry data/provenance, effect-broker, lifecycle and credential boundaries. Promotion prepares a new production operation.

## Context and trade-off

Branching and simulation alone do not isolate effects; copied scenario grants/receipts are invalid production evidence.
...
Worker/context propagation, egress canaries, escaped callbacks and stale promotion tests.
