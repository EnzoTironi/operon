...
Botão, API e agente devem invocar o mesmo contrato autoritativo.
...
- **FULL-ACC-036:** Given uma regra proíbe alterar objeto fechado; when os três canais tentam alterar **Expected:** todos recebem recusa consistente sem atalho no cliente
...
Requirement IDs: FULL-036. Acceptance case IDs: FULL-ACC-036. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
