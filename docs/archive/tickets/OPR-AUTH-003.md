# OPR-AUTH-003 - Distinct human/agent identities
...
Derive subject type and roles from trusted identity records, retaining separate on-behalf-of metadata where appropriate.
...
- **AUTH-003.T01:** Include admin roles, a different tenant, type:user or approver identity in action/tool arguments. **Expected:** The verified subject does not change.
- **AUTH-003.T02:** Attempt agent execution with an invented human approval context. **Expected:** Agent cannot impersonate a human; actor chain remains distinct and authorization is denied.
...
Requirement IDs: AUTH-003. Acceptance case IDs: AUTH-003.T01, AUTH-003.T02, BAI-001, BAI-002, BAI-003, BAI-004, BAI-005, BAI-006, BAI-007, BAI-008, BAI-009, BAI-010, BAI-011, BAI-012, BAI-019, BAI-020, BAI-021, BAI-022, BAI-023, BAI-024. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
