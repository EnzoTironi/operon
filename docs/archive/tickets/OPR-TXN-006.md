# OPR-TXN-006 - Collision-free temporal keys
...
Persist revisions using full declared identity scope and unique revisions, not millisecond timestamps alone.
...
- **TXN-006.T01:** Insert distinct types with equal object ID and timestamp in real storage. **Expected:** Both persist and can be retrieved by full identity.
- **TXN-006.T02:** Commit successive versions under a fixed timestamp. **Expected:** No spurious uniqueness failure and no lost historical version.
...
Requirement IDs: TXN-006. Acceptance case IDs: TXN-006.T01, TXN-006.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
