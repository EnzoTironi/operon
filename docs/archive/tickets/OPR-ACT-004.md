# OPR-ACT-004 - Ordered and explainable criteria
...
Evaluate declarative conditions and delegated complex checks under explicit priority and missingness semantics.
...
- **ACT-004.T01:** Make a hard denial and a review condition true together. **Expected:** Declared priority determines the verdict with a trace; discretionary review cannot waive a hard red line.
- **ACT-004.T02:** Individually fail every guard on a valid fixture. **Expected:** The correct reason and evidence are returned and audited, not a generic unexplained failure.
...
Requirement IDs: ACT-004. Acceptance case IDs: ACT-004.T01, ACT-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
