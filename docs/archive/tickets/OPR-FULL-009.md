...
Preservar tempo de validade e tempo de conhecimento em correções críticas.
...
- **FULL-ACC-009:** Given uma correção chega depois da decisão mas vale antes dela; when consultas usam diferentes known_at para a mesma valid_at **Expected:** os resultados distinguem o conhecimento disponível em cada decisão
...
Requirement IDs: FULL-009. Acceptance case IDs: FULL-ACC-009. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
