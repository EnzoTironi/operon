# OPR-EDU-005 - Evidence review, appeal and exception digestion
...
Verify source evidence, preserve appeal lineage and route exceptions into governed rule review rather than automatic policy mutation.
...
- **EDU-005.T01:** Confirm external-course evidence, deny a request and file an appeal. **Expected:** The original evidence and dossier survive; appeal returns to review.
- **EDU-005.T02:** Collect repeated contextual overrides and propose a rule revision. **Expected:** Review/impact/shadow process handles the candidate; repeated overrides do not self-authorize a new rule.
...
Requirement IDs: EDU-005. Acceptance case IDs: EDU-005.T01, EDU-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
