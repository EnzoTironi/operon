# OPR-TIM-002 - Version-object binding
...
Retain immutable rule, curriculum, permit and model versions with explicit instance-to-version bindings.
...
- **TIM-002.T01:** Release a new rule while replaying decisions bound to an old version. **Expected:** Existing bindings do not silently switch to the latest version.
- **TIM-002.T02:** Remove a required version binding or create conflicting effective versions. **Expected:** The decision is blocked/routed as unresolved; no guessed default version.
...
Requirement IDs: TIM-002. Acceptance case IDs: TIM-002.T01, TIM-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
