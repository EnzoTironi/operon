# OPR-VAL-008 - Honest sampled-repeatability checks
...
Reject zero, negative, NaN and excessive iteration counts; report sampled repeatability separately from formal determinism and process isolation.
...
- **VAL-008.T01:** Run zero iterations and a delayed/nonconstant test model **Expected:** No vacuous proof or all-match success
- **VAL-008.T02:** Run a known deterministic fixture at multiple inputs and bounded positive trials **Expected:** Outputs match the independent oracle and report sample limits
...
Requirement IDs: VAL-008. Acceptance case IDs: VAL-008.T01, VAL-008.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
