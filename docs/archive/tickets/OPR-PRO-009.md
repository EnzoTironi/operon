# OPR-PRO-009 - Bounded deployment, stop and recovery policy
...
Production activation has scope limits, monitoring, a defined stop mechanism and tested recovery; canary percentages, quotas and rollback semantics are agreed per workflow.
...
- **PRO-009.T01:** Activate a small authorized cohort, trigger a failed invariant and pause the responsible grant/release. **Expected:** New work stops within the declared control scope; already committed work is reconciled and recovery is reviewed.
- **PRO-009.T02:** Misroute the stop signal or attempt to resume solely on the proposer/sentinel request. **Expected:** Scope checks and independent resume authority prevent bypass; unsupported rollback is not reported as success.
...
Requirement IDs: PRO-009. Acceptance case IDs: PRO-009.T01, PRO-009.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
