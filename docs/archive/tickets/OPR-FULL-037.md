# OPR-FULL-037 - Interação acessível
...
Fluxos críticos devem funcionar sem depender exclusivamente do chat.
...
- **FULL-ACC-037:** Given um usuário opera por teclado e tabela; when consulta e aprova um plano permitido **Expected:** os elementos são navegáveis e apresentam efeitos e confirmação
...
Requirement IDs: FULL-037. Acceptance case IDs: FULL-ACC-037. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
