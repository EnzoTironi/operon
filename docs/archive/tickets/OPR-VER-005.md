# OPR-VER-005 - Bounded action-space safety
...
Search authorized sequences under explicit state abstraction, invariants, horizon, effect fragment, clocks and environmental assumptions.
...
- **VER-005.T01:** Use a small fixture with a known multi-step violation invisible to local single-step guards. **Expected:** Return a replayable violating sequence with the relevant states/authority.
- **VER-005.T02:** Run a safe finite fixture and one exceeding time/state bounds. **Expected:** Report safe-within-scope separately from unknown/timeout; retain resource and horizon data.
...
Requirement IDs: VER-005. Acceptance case IDs: VER-005.T01, VER-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
