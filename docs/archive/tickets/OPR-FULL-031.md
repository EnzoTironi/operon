...
Gerar ChangeSet com modelos, impacto, migração, testes e release-alvo.
...
- **FULL-ACC-031:** Given um pedido adiciona nova regra e propriedade; when o construtor prepara mudança **Expected:** dependentes e migrações afetados aparecem no pacote revisável
...
Requirement IDs: FULL-031. Acceptance case IDs: FULL-ACC-031. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
