# OPR-SCH-004 - Three property sources
...
Respect source-mapped, derived and human/action-entered property ownership and preserve origin.
...
- **SCH-004.T01:** Try editing a derived value directly, or overwriting a protected human edit through source sync. **Expected:** Unpermitted writes are rejected/mediated and explain the owning source.
- **SCH-004.T02:** Produce one value by each source path. **Expected:** Originating source/field, function/version, or action/actor is retained and queryable.
...
Requirement IDs: SCH-004. Acceptance case IDs: SCH-004.T01, SCH-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
