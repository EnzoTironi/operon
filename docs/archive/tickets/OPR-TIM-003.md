# OPR-TIM-003 - Time-travel and replay
...
Reconstruct historical values and applicable logic using materialized evidence or valid retained temporal references.
...
- **TIM-003.T01:** Query world-at and system-knew-at views around a late correction and policy change. **Expected:** Historical decisions recover their original basis, not subsequently corrected knowledge.
- **TIM-003.T02:** Recompute or load a historical derived value after its algorithm changes. **Expected:** The retained algorithm/input versions are used; unsupported recomputation is disclosed.
...
Requirement IDs: TIM-003. Acceptance case IDs: TIM-003.T01, TIM-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
