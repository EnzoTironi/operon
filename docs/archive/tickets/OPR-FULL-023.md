# OPR-FULL-023 - Planejamento limitado
...
Toda etapa do plano deve caber em ações publicadas e no grant.
...
- **FULL-ACC-023:** Given um otimizador propõe resultado melhor violando restrição obrigatória; when o plano passa pelo verificador **Expected:** é recusado independentemente da pontuação de objetivo
...
Requirement IDs: FULL-023. Acceptance case IDs: FULL-ACC-023. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
