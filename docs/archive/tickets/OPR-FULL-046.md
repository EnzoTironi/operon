# OPR-FULL-046 - Contrato intercélulas
...
Operações multicélula devem expor estado parcial e reconciliação.
...
- **FULL-ACC-046:** Given a segunda célula fica indisponível após reserva na primeira; when o workflow avança **Expected:** registra pendência e trata prazo/compensação sem inventar commit global
...
Requirement IDs: FULL-046. Acceptance case IDs: FULL-ACC-046. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
