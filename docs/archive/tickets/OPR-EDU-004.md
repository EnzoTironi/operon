# OPR-EDU-004 - Proof-producing adjudication and dual versions
...
Run the documented five classes against native/external integration and preserve VerificationRecords.
...
- **EDU-004.T01:** Run positive, grade/count boundary, missing, CAPSTONE-conflict and temporal version fixtures. **Expected:** All expected verdicts, source rules, snapshots and traces are retained.
- **EDU-004.T02:** Reorder/delete the CAPSTONE rule or alter a threshold. **Expected:** Independent regression/fidelity checks detect the changed admissible set.
...
Requirement IDs: EDU-004. Acceptance case IDs: EDU-004.T01, EDU-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
