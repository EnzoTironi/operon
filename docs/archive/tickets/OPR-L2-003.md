# OPR-L2-003 - Cited claims with resolvable support
...
Resolve claim-to-evidence links to real IDs/versions/spans; distinguish evidence existence from semantic support.
...
- **L2-003.T01:** Provide missing IDs, wrong version, out-of-bounds span, inaccessible evidence or a real but unrelated span. **Expected:** Fabrication fails resolution; unrelated support is rejected by structured checks or routed to explicit human evaluation, not automatically certified.
- **L2-003.T02:** Edit the source after extraction. **Expected:** The original pinned content is retained or the citation is invalidated and requires readmission.
...
Requirement IDs: L2-003. Acceptance case IDs: L2-003.T01, L2-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
