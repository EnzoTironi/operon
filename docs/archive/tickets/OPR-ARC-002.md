# OPR-ARC-002 - Platform-neutral business assets
...
Domain definitions and rules remain exportable with their semantics, not just as database dumps.
...
- **ARC-002.T01:** Export a domain, rules and evidence corpus, then load a clean neutral evaluator. **Expected:** Matching decisions and identity/version bindings are reproduced for the declared supported fragment.
- **ARC-002.T02:** Import a definition with an unsupported expression or platform binding. **Expected:** It is explicitly rejected or marked unresolved, never silently discarded.
...
Requirement IDs: ARC-002. Acceptance case IDs: ARC-002.T01, ARC-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
