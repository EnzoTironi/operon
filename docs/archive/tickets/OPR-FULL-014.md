# OPR-FULL-014 - Orçamento agregado
...
Consumir limites de grants atomicamente entre agentes e missões.
...
- **FULL-ACC-014:** Given dois agentes compartilham orçamento suficiente para uma operação; when ambos tentam reservar o total ao mesmo tempo **Expected:** no máximo uma reserva é aceita e nenhum subagente amplia o limite
...
Requirement IDs: FULL-014. Acceptance case IDs: FULL-ACC-014. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
