# OPR-FULL-010 - Conjunto e predicado
...
Object Sets dinâmicos devem declarar congelamento ou reavaliação de membros.
...
- **FULL-ACC-010:** Given um novo bloqueio entra no predicado após a proposta; when a ação é comprometida **Expected:** o novo bloqueio é considerado e a proposta obsoleta não autoriza a execução
...
Requirement IDs: FULL-010. Acceptance case IDs: FULL-ACC-010. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
