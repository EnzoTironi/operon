# OPR-FULL-050 - Localidade completa
...
Perfil de região deve cobrir modelos, logs, backups e derivados.
...
- **FULL-ACC-050:** Given um roteamento de modelo envia dados fora da região permitida; when o gateway avalia a chamada **Expected:** a chamada é bloqueada antes de transmitir o conteúdo
...
Requirement IDs: FULL-050. Acceptance case IDs: FULL-ACC-050. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
