# OPR-AGT-005 - Memory and telemetry governance
...
Treat agent memory as governed data and retain reconstructable tool/evidence traces, not inaccessible private chain-of-thought.
...
- **AGT-005.T01:** Store malicious or cross-tenant content and later retrieve it in another scope. **Expected:** Content cannot grant authority or cross policy boundaries; sensitive retention rules apply.
...
Requirement IDs: AGT-005. Acceptance case IDs: AGT-005.T01, AGT-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
