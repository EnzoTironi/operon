# OPR-AUD-006 - Override feedback and accountability
...
Retain the book’s five reason categories and route each to a responsible improvement queue; other has an owner.
...
- **AUD-006.T01:** Submit missing evidence, contextual exception, outdated rule, model out of scope and other. **Expected:** Each links the original proposal, human decision/signature and an owned disposition queue.
- **AUD-006.T02:** Resolve an override via an approved requirement/rule/scope revision. **Expected:** The originator can trace the disposition and resulting version; no silent auto-edit to policy.
...
Requirement IDs: AUD-006. Acceptance case IDs: AUD-006.T01, AUD-006.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
