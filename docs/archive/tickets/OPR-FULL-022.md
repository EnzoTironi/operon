...
O planner deve poder obter evidência faltante por ações permitidas.
...
- **FULL-ACC-022:** Given uma fonte necessária está incompleta e há conector autorizado; when o planner prepara continuação **Expected:** propõe coleta com orçamento e não fabrica o fato que falta
...
Requirement IDs: FULL-022. Acceptance case IDs: FULL-ACC-022. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
