...
LLM outputs are candidates, never authorizations or admitted facts; tool access is least-privilege and explicit.
...
Requirement IDs: AGT-004. Acceptance case IDs: AGT-004.T01, AGT-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
