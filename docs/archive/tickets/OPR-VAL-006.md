# OPR-VAL-006 - True action preview
...
Preview uses the shared preparation contract, reports checks not performed, and does not seed/edit business state or generate live effects.
...
- **VAL-006.T01:** Preview a schema-valid but denied/stale/capacity-invalid action **Expected:** The preview does not imply executable authorization
- **VAL-006.T02:** Diff object/audit/side-effect receiver before and after preview **Expected:** No business mutation or external effect; expected preparation output is returned
...
Requirement IDs: VAL-006. Acceptance case IDs: VAL-006.T01, VAL-006.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
