# OPR-ING-003 - Deduplication and ordering
...
Persist source event identities/checkpoints and define late, duplicate and reordered event semantics.
...
- **ING-003.T01:** Replay an accepted event before and after restart. **Expected:** It does not create duplicate observations or repeat downstream logical work.
- **ING-003.T02:** Receive newer and older observations in reverse order. **Expected:** Current state follows valid-time policy; older observations remain in history.
...
Requirement IDs: ING-003. Acceptance case IDs: ING-003.T01, ING-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
