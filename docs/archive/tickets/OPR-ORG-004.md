# OPR-ORG-004 - Accessible product without mandatory vendor accounts
...
The supported local core can be installed and used without a Palantir contract or mandatory paid model/cloud account; advanced optional services are explicit.
...
- **ORG-004.T01:** Complete a local deterministic workflow with optional cloud/model connections disabled. **Expected:** Core evidence, rules, approvals, execution simulation and replay work with clear optional-feature boundaries.
- **ORG-004.T02:** Inspect quickstart, resource requirements and optional service pricing disclosures supplied by the product team. **Expected:** Users can distinguish free/self-hosted core from optional external costs; no untested everyone-scale promise.
...
Requirement IDs: ORG-004. Acceptance case IDs: ORG-004.T01, ORG-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
