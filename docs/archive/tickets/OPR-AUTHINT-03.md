# OPR-AUTHINT-03 - Integrate human sessions and step-up
...
Mount Better Auth sessions/passkeys/SSO with database sessions, business CSRF and exact proxy origins; make review proof refer to approved digest.
