# OPR-ING-004 - Quarantine and accountable admission
...
Failed evidence admission has a visible disposition and cannot silently become authoritative fact.
...
- **ING-004.T01:** Submit impossible values, untrusted origin and unresolved contradictions. **Expected:** Quarantine/review identifies cause and missingness; affected decisions cannot assume successful admission.
- **ING-004.T02:** Correct and approve a quarantined record. **Expected:** Original and corrected evidence, reviewers and admission decision are linked.
...
Requirement IDs: ING-004. Acceptance case IDs: ING-004.T01, ING-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
