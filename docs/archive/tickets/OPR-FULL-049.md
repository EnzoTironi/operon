# OPR-FULL-049 - Recuperação mensurada
...
Restore e continuidade devem ser demonstrados contra RPO/RTO declarados.
...
- **FULL-ACC-049:** Given um backup e diário de eventos estão disponíveis; when uma célula é restaurada no exercício **Expected:** IDs e estado reconciliado são verificados e métricas são registradas
...
Requirement IDs: FULL-049. Acceptance case IDs: FULL-ACC-049. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
