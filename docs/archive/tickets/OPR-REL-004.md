# OPR-REL-004 - Governed entity resolution
...
Resolve duplicate real-world identities with explicit matching evidence, conflict handling and link reconnection.
...
- **REL-004.T01:** Review a duplicate pair with conflicting property authorities and incoming/outgoing links. **Expected:** Approved merge preserves aliases/provenance and valid links atomically; ambiguous matches remain unresolved.
- **REL-004.T02:** Withdraw an erroneous match through an authorized correction. **Expected:** Original identities/evidence remain traceable; correction does not erase prior decision context.
...
Requirement IDs: REL-004. Acceptance case IDs: REL-004.T01, REL-004.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
