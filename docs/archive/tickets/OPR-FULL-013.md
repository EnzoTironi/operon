# OPR-FULL-013 - Identidade confiável
...
Tenant e principal devem ser resolvidos fora do payload livre do agente.
...
- **FULL-ACC-013:** Given um agente altera o tenant no pedido; when o executor autentica a chamada **Expected:** o pedido é recusado ou restringido ao tenant confiável sem acesso cruzado
...
Requirement IDs: FULL-013. Acceptance case IDs: FULL-ACC-013. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
