# OPR-AUTH-004 - Registered keys without public bootstrap secrets
...
Provision, scope, rotate and revoke consumer/builder keys; public demo keys are not enabled in a normal runtime.
...
- **AUTH-004.T01:** Start a non-demo instance and try every publicly documented bootstrap key. **Expected:** All are rejected unless explicitly created by an isolated demo configuration.
- **AUTH-004.T02:** Rotate/revoke a builder key while sessions are active. **Expected:** Old authority is removed according to a declared short revocation bound; secrets never appear in logs.
...
Requirement IDs: AUTH-004. Acceptance case IDs: AUTH-004.T01, AUTH-004.T02, BAI-013, BAI-014, BAI-015, BAI-016, BAI-017, BAI-018, BAI-019, BAI-020, BAI-021, BAI-022, BAI-023, BAI-024, BAI-049, BAI-050, BAI-051, BAI-052, BAI-053, BAI-054. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
