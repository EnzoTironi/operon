# OPR-FULL-007 - Cobertura de evidência
...
A decisão deve identificar R(d), atualidade e cobertura por origem.
...
- **FULL-ACC-007:** Given uma evidência obrigatória está atrasada; when a decisão é avaliada **Expected:** retorna evidência insuficiente e não inventa uma observação atual
...
Requirement IDs: FULL-007. Acceptance case IDs: FULL-ACC-007. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
