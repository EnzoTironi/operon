# OPR-FULL-041 - Cobertura explícita
...
Prontidão de pacote deve ser declarada por funcionalidades, perfil e testes aceitos.
...
- **FULL-ACC-041:** Given um pacote só contém schemas e telas; when a factory avalia seu status **Expected:** não recebe ready_for_production nem equivalência genérica a ERP/QMS
...
Requirement IDs: FULL-041. Acceptance case IDs: FULL-ACC-041. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
