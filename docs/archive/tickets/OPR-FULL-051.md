# OPR-FULL-051 - Contrato de tarefa
...
Cada tarefa deve declarar entradas, escopo, dependências e evidência exigida.
...
- **FULL-ACC-051:** Given um agente recebe uma tarefa sem contrato aprovado; when o executor tenta liberar escrita protegida **Expected:** nega a permissão e aponta o requisito faltante
...
Requirement IDs: FULL-051. Acceptance case IDs: FULL-ACC-051. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
