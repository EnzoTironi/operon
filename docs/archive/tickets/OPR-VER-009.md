# OPR-VER-009 - H1/H2/H3 experimental contracts
...
Evaluate compilation mutants, bounded-search scalability and no-guard/L1/L1+L2 decision quality using reproducible corpora.
...
- **VER-009.T01:** Run held-out seeded mutations and injected missing evidence/conflict/prompt-injection scenarios. **Expected:** Publish false permission, false rejection, detection/false-positive rates and cycle cost; retain undetected mutants.
- **VER-009.T02:** Force solver limits and guard friction; publish denominators and excluded cases. **Expected:** Timeouts, coverage loss and tradeoffs appear beside successes, not silently removed.
...
Requirement IDs: VER-009. Acceptance case IDs: VER-009.T01, VER-009.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
