# OPR-FULL-034 - Compatibilidade viva
...
Releases devem classificar propostas e missões em andamento.
...
- **FULL-ACC-034:** Given uma nova regra invalida uma aprovação pendente; when a release é ativada **Expected:** a aprovação é reavaliada e não executa pelo contrato antigo indevidamente
...
Requirement IDs: FULL-034. Acceptance case IDs: FULL-ACC-034. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
