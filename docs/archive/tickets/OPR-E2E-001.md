# OPR-E2E-001 - Reference decision workflow
...
Maintain one registered object-changing fixture through source ingestion, query, guarded proposal, independent approval, execution, external observation and replay.
...
- **E2E-001.T01:** Execute the workflow through each real HTTP/MCP/SDK interface with an independent reviewer and receiver. **Expected:** Expected domain change, durable dossier and observed delivery appear exactly as declared.
- **E2E-001.T02:** Combine stale evidence, revoked authority, duplicate submissions and a lost external reply. **Expected:** No forged approval, duplicate local transition or false delivery success; unresolved work is visible.
...
Requirement IDs: E2E-001. Acceptance case IDs: E2E-001.T01, E2E-001.T02, BAI-055, BAI-056, BAI-057, BAI-058, BAI-059, BAI-060. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
