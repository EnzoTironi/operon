# OPR-FULL-028 - Isolamento de cenário
...
Cenários não devem possuir canais de efeito real.
...
- **FULL-ACC-028:** Given um cenário chama uma ação de expedição; when o sandbox executa o plano **Expected:** somente o simulador recebe o efeito e nenhuma credencial real é disponível
...
Requirement IDs: FULL-028. Acceptance case IDs: FULL-ACC-028. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
