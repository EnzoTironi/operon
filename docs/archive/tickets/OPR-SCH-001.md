# OPR-SCH-001 - Object contracts and stable identity
...
Model object types/instances with semantic identity, title and type-safe properties; technical source keys do not silently determine real-world identity.
...
- **SCH-001.T01:** Create the same source identifier in different declared tenant/ontology/type scopes. **Expected:** No collision or cross-scope read; identity scope is documented.
- **SCH-001.T02:** Register duplicate fields, missing IDs, invalid enum values or unresolved type references. **Expected:** Registration fails with precise diagnostics before runtime use.
...
Requirement IDs: SCH-001. Acceptance case IDs: SCH-001.T01, SCH-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
