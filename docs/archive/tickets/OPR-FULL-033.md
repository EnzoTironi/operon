# OPR-FULL-033 - Canário e rollback
...
Rollback de software não deve apagar resultados operacionais reais.
...
- **FULL-ACC-033:** Given uma versão canário realizou uma operação confirmada; when a versão é revertida **Expected:** o evento permanece e qualquer reparo passa por ação explícita
...
Requirement IDs: FULL-033. Acceptance case IDs: FULL-ACC-033. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
