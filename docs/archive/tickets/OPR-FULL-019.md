# OPR-FULL-019 - Guard contra concorrência
...
Validar objetos e predicados críticos no limite transacional apropriado.
...
- **FULL-ACC-019:** Given duas ações leem recursos suficientes isoladamente mas o total é insuficiente; when ambas tentam confirmar **Expected:** o invariante é preservado e o conflito tem resultado explícito
...
Requirement IDs: FULL-019. Acceptance case IDs: FULL-ACC-019. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
