...
Salas e artefatos derivados devem respeitar audiência e retirada de acesso.
...
- **FULL-ACC-038:** Given um usuário deixa um grupo restrito; when abre link anterior ou busca memória do grupo **Expected:** acesso é revogado inclusive em cache e conteúdo derivado
...
Requirement IDs: FULL-038. Acceptance case IDs: FULL-ACC-038. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
