# OPR-FULL-048 - Isolamento de recursos
...
Cotas devem impedir que uma carga de tenant retire recursos reservados a outro.
...
- **FULL-ACC-048:** Given um tenant envia missões acima da cota; when outro executa sob seu perfil **Expected:** a primeira carga é limitada e a segunda preserva o objetivo medido
...
Requirement IDs: FULL-048. Acceptance case IDs: FULL-ACC-048. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
