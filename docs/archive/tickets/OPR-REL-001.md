# OPR-REL-001 - Typed links and inverse traversal
...
Define semantic name, endpoints, direction, description, cardinality and inverse traversal without requiring duplicate inverse facts.
...
- **REL-001.T01:** Create links with missing or incorrectly typed endpoints. **Expected:** No dangling or mistyped relation is committed.
- **REL-001.T02:** Traverse the same stored relation forward and backward. **Expected:** Results and permissions are equivalent to the declared direction semantics.
...
Requirement IDs: REL-001. Acceptance case IDs: REL-001.T01, REL-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
