# OPR-REL-003 - Relationship reification and time
...
Represent relationships with independent evidence, attributes or lifecycle as objects; preserve temporal/conditional relation meaning.
...
- **REL-003.T01:** Record enrollment grade/term/status and a relationship source/certainty as applicable. **Expected:** Attributes attach to the relationship instance, not arbitrarily to an endpoint.
- **REL-003.T02:** Change a condition/version and query current and historical applicability. **Expected:** The relation is evaluated under the correct condition/version; history remains reconstructable.
...
Requirement IDs: REL-003. Acceptance case IDs: REL-003.T01, REL-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
