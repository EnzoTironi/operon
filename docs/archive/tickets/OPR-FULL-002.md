# OPR-FULL-002 - Projeções coerentes
...
Formulário, tool schema e validador de ação devem derivar da mesma definição e revisão.
...
- **FULL-ACC-002:** Given uma ação exige parâmetro enum versionado; when a UI e a ferramenta são geradas **Expected:** ambas rejeitam valores fora do enum e registram a mesma revisão
...
Requirement IDs: FULL-002. Acceptance case IDs: FULL-ACC-002. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
