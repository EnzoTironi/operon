# OPR-ORG-002 - Incremental adoption and portable exit
...
Support read-only/shadow introduction before actions and a practical export/cold-start exit exercise.
...
- **ORG-002.T01:** Connect sources and evaluate proposals in shadow without production write authority. **Expected:** No business or remote state changes, with observable readiness and proposed differences.
- **ORG-002.T02:** Export neutral models, rules, test corpus and required history; reconstruct a decision on a clean alternative setup. **Expected:** Essential semantics and evidence survive without a mandatory Palantir contract.
...
Requirement IDs: ORG-002. Acceptance case IDs: ORG-002.T01, ORG-002.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
