# OPR-ING-001 - Batch and streaming/event ingestion
...
Ingest source changes through explicit mappings into validated ontology objects, relationships and state.
...
- **ING-001.T01:** Feed an equivalent fixture through batch and event paths. **Expected:** Equivalent logical source facts and lineage result, allowing declared delivery ordering differences.
- **ING-001.T02:** Introduce unknown columns, incompatible types and deleted source attributes. **Expected:** Mapping/schema changes are reported and governed; no corrupt silent coercion.
...
Requirement IDs: ING-001. Acceptance case IDs: ING-001.T01, ING-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
