...
Não atualizar valor externo confirmado antes de obter evidência da origem.
...
- **FULL-ACC-020:** Given um prazo externo foi solicitado mas a origem recusou; when a reconciliação termina **Expected:** a projeção mantém o valor confirmado anterior e registra a recusa
...
Requirement IDs: FULL-020. Acceptance case IDs: FULL-ACC-020. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
