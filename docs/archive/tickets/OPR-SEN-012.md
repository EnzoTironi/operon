# OPR-SEN-012 - Simulation review versus production review
...
In a certified synthetic scenario the sentinel may advise without approving every edit; promotion and required production actions obtain separately bound reviews against applicable production constraints.
...
- **SEN-012.T01:** Explore intentionally invalid alternatives in a synthetic scenario, then submit the chosen action for production promotion. **Expected:** Experimentation can continue within containment; production review evaluates current reality and never inherits scenario clearance.
- **SEN-012.T02:** Replay a scenario-only favorable review as a production authorization or relabel a safety violation as harmless experiment text. **Expected:** Environment and candidate binding reject the replay; scenario feedback remains advisory.
...
Requirement IDs: SEN-012. Acceptance case IDs: SEN-012.T01, SEN-012.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
