# OPR-FDE-003 - Generated-code and artifact validation
...
Sandbox generated code with declared filesystem/network/secret limits and reproducible validation evidence.
...
- **FDE-003.T01:** Attempt shell escape, data exfiltration, secret access and undeclared dependencies from generated work. **Expected:** Sandbox and approval boundaries contain it; generated tests alone cannot certify the generated behavior.
- **FDE-003.T02:** Execute independent acceptance fixtures against generated transformations and their outputs. **Expected:** Expected mappings/data quality/lineage hold; compile success alone is insufficient.
...
Requirement IDs: FDE-003. Acceptance case IDs: FDE-003.T01, FDE-003.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
