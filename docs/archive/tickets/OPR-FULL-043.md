# OPR-FULL-043 - Conector contratado
...
Cada conector deve declarar CDC/polling, versões, idempotência, reconciliação e limites.
...
- **FULL-ACC-043:** Given uma origem não oferece comando condicional; when um pacote exige essa garantia **Expected:** a incompatibilidade é explícita e não escondida por um wrapper
...
Requirement IDs: FULL-043. Acceptance case IDs: FULL-ACC-043. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
