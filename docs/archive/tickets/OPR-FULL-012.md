# OPR-FULL-012 - Snapshots federados
...
WorldViews multiorigem devem expor revisões e diferença de frescor.
...
- **FULL-ACC-012:** Given duas fontes foram observadas em momentos distintos; when o plano as utiliza **Expected:** as revisões são registradas sem afirmar atomicidade global inexistente
...
Requirement IDs: FULL-012. Acceptance case IDs: FULL-ACC-012. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
