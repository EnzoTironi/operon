# OPR-VER-007 - P-comp commitment restoration
...
Define business invariants and commitment balance for compensation rather than equality with historical state.
...
- **VER-007.T01:** Execute forward/compensation sequences with irreversible or failed steps. **Expected:** The checker distinguishes restored business invariants from unsettled commitments.
- **VER-007.T02:** Compare modeled compensation guarantees with tested real connector capabilities. **Expected:** Unsupported environmental assumptions prevent an unqualified restoration claim.
...
Requirement IDs: VER-007. Acceptance case IDs: VER-007.T01, VER-007.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
