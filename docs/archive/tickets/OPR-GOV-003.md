# OPR-GOV-003 - Safe merge and migrations
...
Merge against the reviewed base, atomically activate a version and migrate compatible data with rollback/recovery planning.
...
- **GOV-003.T01:** Update main after branch review, then attempt merge. **Expected:** Conflict or renewed impact/testing/review is required.
- **GOV-003.T02:** Inject failure halfway through a schema/data migration and restart. **Expected:** Documented old/new consistent state or resumable migration; no partially active contract.
...
Requirement IDs: GOV-003. Acceptance case IDs: GOV-003.T01, GOV-003.T02, BAI-025, BAI-026, BAI-027, BAI-028, BAI-029, BAI-030, BAI-049, BAI-050, BAI-051, BAI-052, BAI-053, BAI-054. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
