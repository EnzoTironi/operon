# OPR-FULL-003 - Pacotes e dependências
...
Resolver imports por versão e digest, sem conceder permissões por importação.
...
- **FULL-ACC-003:** Given um pacote importa ação restrita de outro módulo; when um usuário sem grant tenta executá-la **Expected:** a referência resolve mas a execução continua negada
...
Requirement IDs: FULL-003. Acceptance case IDs: FULL-ACC-003. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
