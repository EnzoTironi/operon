# OPR-ING-005 - Source and field-level lineage
...
Retain ingestion batches/events, origin fields, sampling and recording time, transformations and responsible actors.
...
- **ING-005.T01:** Follow a decision’s derived value to input records and their original source events. **Expected:** The chain resolves with exact versions and available original evidence.
- **ING-005.T02:** Rebuild a materialized index from retained source events and authorized edits. **Expected:** Rebuilt logical state matches the declared merge semantics and preserves lineage.
...
Requirement IDs: ING-005. Acceptance case IDs: ING-005.T01, ING-005.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
