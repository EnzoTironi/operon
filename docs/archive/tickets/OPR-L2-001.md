# OPR-L2-001 - Correct output against registered context
...
Check structured factual assertions against the exact visible, versioned evidence context; absent source properties do not count as agreement.
...
- **L2-001.T01:** Return the wrong number, nonexistent object, absent source property or wrong source version. **Expected:** Output is unverified/blocked with a precise mismatch, not marked correct.
- **L2-001.T02:** Faithfully restate a known synthetic incorrect source value. **Expected:** L2 may agree with context while the report preserves L1 uncertainty; it is not called objectively true.
...
Requirement IDs: L2-001. Acceptance case IDs: L2-001.T01, L2-001.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
