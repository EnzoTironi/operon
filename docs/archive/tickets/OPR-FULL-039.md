# OPR-FULL-039 - Composição comercial
...
CRM, suprimentos e finanças devem compartilhar identidades e contratos, não sincronizar três verdades paralelas.
...
- **FULL-ACC-039:** Given pedido deriva de oportunidade comercial; when reserva, expedição e faturamento são confirmados **Expected:** o histórico correlaciona a mesma operação e seus estados por domínio
...
Requirement IDs: FULL-039. Acceptance case IDs: FULL-ACC-039. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
