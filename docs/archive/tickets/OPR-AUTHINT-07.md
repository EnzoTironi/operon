# OPR-AUTHINT-07 - Define typed intent and policy semantics
...
Publish minimal IR, authority/scope lattice, exact units, outcome predicates, ambiguity rules and canonical approval representation; no arbitrary model permit.
