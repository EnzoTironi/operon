# OPR-APR-001 - Persisted proposal identity
...
Proposals and approval records are durable immutable/versioned objects, not mutable in-memory authorization flags.
...
- **APR-001.T01:** Create through HTTP and MCP, restart and open the approval queue. **Expected:** The proposal, evidence basis and requester survive and appear once.
- **APR-001.T02:** Change submitted/returned nested proposal objects without a governed action. **Expected:** Persisted proposal content and authorization remain unchanged.
