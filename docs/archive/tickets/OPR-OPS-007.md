# OPR-OPS-007 - Performance and availability targets
...
Define and measure realistic workload, latency, throughput, freshness, memory and recovery objectives on declared hardware/topology.
...
- **OPS-007.T01:** Benchmark mixed reads/proposals/approvals/ingestion under the agreed workload and dataset. **Expected:** Report p50/p95/p99, errors, resources and data freshness against signed targets; no invented universal SLA.
- **OPS-007.T02:** Run sustained load, burst/backlog and dependency slowness. **Expected:** The system degrades within policy, preserves invariants and reports limits/leaks.
...
Requirement IDs: OPS-007. Acceptance case IDs: OPS-007.T01, OPS-007.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
