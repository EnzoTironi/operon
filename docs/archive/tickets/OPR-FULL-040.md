# OPR-FULL-040 - Conservação e saldos
...
Os pacotes devem implementar invariantes especializados no commit.
...
- **FULL-ACC-040:** Given duas reservas competem pelo mesmo estoque disponível; when as confirmações ocorrem concorrentemente **Expected:** o perfil de estoque impede disponibilidade impossível
...
Requirement IDs: FULL-040. Acceptance case IDs: FULL-ACC-040. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
