# OPR-OPS-009 - Supply-chain and release integrity
...
Review dependency advisories/licenses, provenance, artifact hashes and upgrade compatibility without silently upgrading the Effect target.
...
- **OPS-009.T01:** Generate dependency/license/SBOM and source/build artifact inventories from the actual release. **Expected:** Every shipped component is accounted for; known risks have documented disposition.
- **OPS-009.T02:** Update an explicitly selected dependency/version in a branch and rerun acceptance on retained fixtures. **Expected:** Schema projections, Effect behavior, database migrations and clients remain compatible or require governed changes.
...
Requirement IDs: OPS-009. Acceptance case IDs: OPS-009.T01, OPS-009.T02. These identifiers preserve audit lineage; no external file is required to execute or judge this ticket.
