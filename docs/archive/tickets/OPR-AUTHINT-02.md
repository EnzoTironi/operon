# OPR-AUTHINT-02 - Introduce trusted PrincipalContext
...
Replace generic claim casts with explicit profiles and issuer-specific mapping; separate human initiator, actual agent/workload, sponsor, tenant, assurance and resource audience.
