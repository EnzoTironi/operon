...
// root barrel — host code imports it from `@operon/gateway/sdk/host-internal`.
// ---------------------------------------------------------------------------

import { fumadb, type FumaDB } from "@operon/gateway/store";
import { type DrizzleRuntimeProvider } from "@operon/gateway/store/adapters/drizzle";
import { drizzleAdapter } from "@operon/gateway/store/adapters/drizzle";
