import { column, idColumn, table, type AnyColumn, type AnyTable } from "@operon/gateway/store/schema";
import type { Condition, ConditionBuilder } from "@operon/gateway/store/query";
...
export const coreTables = defineTables({
  ...
  artifact: ownedExecutorTable(
    "artifact",
    {
      ...
      // `resolveCallAddress` in `@operon/gateway/mcp`.
