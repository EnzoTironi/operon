...
import { AuthTemplateSlug, type OAuthAuthentication } from "@operon/gateway/sdk/shared";
import {
  apiKeyMethodFromAuthTemplate,
  isApiKeyAuthTemplate,
  type ApiKeyAuthMethod,
  type ApiKeyAuthTemplate,
} from "@operon/gateway/sdk/http-auth";

// ---------------------------------------------------------------------------
// Auth-template model.
//
// The apiKey method is the SHARED placements model (`@operon/gateway/sdk/http-auth`,
...
export { TOKEN_VARIABLE } from "@operon/gateway/sdk/http-auth";
