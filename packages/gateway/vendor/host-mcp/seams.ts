...
import type { OrgWriteAccess } from "@operon/gateway/sdk";
...
>()("@operon/gateway/mcp/McpAuthProvider") {}
...
>()("@operon/gateway/mcp/McpSessionStore") {}
...
>()("@operon/gateway/mcp/McpErrorReporter") {}
