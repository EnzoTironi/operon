// ---------------------------------------------------------------------------
// @operon/gateway/execution/promise — Promise-native surface for the execution
// engine.
// ---------------------------------------------------------------------------
//
...
// from `@operon/gateway/execution` to keep trace context intact.
// ---------------------------------------------------------------------------
...
import type { Executor as PromiseExecutor } from "@operon/gateway/sdk/promise";
import type { CodeExecutionError, CodeExecutor, ExecuteResult } from "@operon/gateway/sandbox-core";
